...
In this demo we are using our [Kafka operator](/docs/supertubes/kafka-operator/). For details on installing it, see the [Kafka operator installation guide](/docs/supertubes/kafka-operator/quickstart/install-kafka-operator/).
