...
| **[Prometheus](filters/prometheus/)** | filters | Prometheus Filter Plugin to count Incoming Records | GA | [2.0.1](https://github.com/fluent/fluent-plugin-prometheus#prometheus-outputfilter-plugin) |
...
| **[Kafka](outputs/kafka/)** | outputs | Send your logs to Kafka | GA | [0.16.3](https://github.com/fluent/fluent-plugin-kafka/releases/tag/v0.16.3) |
...
| **[NewRelic Logs](outputs/newrelic/)** | outputs | Send logs to New Relic Logs | GA | [1.2.0](https://github.com/newrelic/newrelic-fluentd-output) |
...
| **[Amazon S3](outputs/s3/)** | outputs | Store logs in Amazon S3 | GA | [1.6.0](https://github.com/fluent/fluent-plugin-s3/releases/tag/v1.6.0) |
