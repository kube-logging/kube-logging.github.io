...
| **[Amazon CloudWatch](outputs/cloudwatch/)** | outputs | Send your logs to AWS CloudWatch | GA | [0.13.2](https://github.com/fluent-plugins-nursery/fluent-plugin-cloudwatch-logs/releases/tag/v0.13.2) |
...
| **[Elasticsearch](outputs/elasticsearch/)** | outputs | Send your logs to Elasticsearch | GA | [4.3.3](https://github.com/uken/fluent-plugin-elasticsearch/releases/tag/v4.3.3) |
...
| **[Kafka](outputs/kafka/)** | outputs | Send your logs to Kafka | GA | [0.15.3](https://github.com/fluent/fluent-plugin-kafka/releases/tag/v0.15.3) |
...
| **[Http](outputs/redis/)** | outputs | Sends logs to Redis endpoints. | GA | [0.3.5](https://github.com/fluent-plugins-nursery/fluent-plugin-redis) |
